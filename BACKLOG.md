...
- [ ] **Hjælp til VSO stamdata** – ud for hvert felt gives oplysninger om hvad det er (evt med relevante links til skats hjemmeside) og hvor man kan finde det relevante data, kapitalafkastsats, rentekorrektionssats, indskudskonto etc.
...
- [ ] **projekt README** – med generel beskrivelse og instruktioner om afvikling, test mv.
